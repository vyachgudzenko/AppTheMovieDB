    ...
    var body: some View {
        ZStack{
            ...
            VStack{
                ...
                Button {
                    print("request token \(authorizationVM.requestToken)")
                    print("auth info \(authorizationVM.authorizationInfo)")
                    print("verified token \(authorizationVM.verifiedToken)")
                    print("session id \(authorizationVM.sessionId)")
                } label: {
                    Text("Go")
